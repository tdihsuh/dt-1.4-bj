...
class Gx019InSpider(scrapy.Spider):
    name = 'crawler114_o_19'
    allowed_domains = ['gx.gsxt.gov.cn']
    start_urls = ['http://gx.gsxt.gov.cn/xxgg/xxggAction!queryGgxx.dhtml?vchr_bmdm=&notitype=12&noticeTitle=%E8%AF%B7%E8%BE%93%E5%85%A5%E9%9C%80%E8%A6%81%E6%9F%A5%E8%AF%A2%E4%BF%A1%E6%81%AF&pageNos=1']
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            item['ent_name'] = title.replace(u'关于将', '').replace(u'移出经营异常名录的公告', '').replace(u'移出经营异常名录的', '').replace(u'移出经营异常名录', '')
        ...
        if int(cur_page) < int(total_pages):
            ...
            next_href ='http://gx.gsxt.gov.cn/xxgg/xxggAction!queryGgxx.dhtml?vchr_bmdm=&notitype=12&noticeTitle=%E8%AF%B7%E8%BE%93%E5%85%A5%E9%9C%80%E8%A6%81%E6%9F%A5%E8%AF%A2%E4%BF%A1%E6%81%AF&pageNos='+str(next_page)
    ...
    def parse_detail(self, response):
        ...
        item['release_reason'] = response.xpath('//div[@class="box"]/div/p[1]/span/text()').extract_first().replace(u'\xa0', u' ')
